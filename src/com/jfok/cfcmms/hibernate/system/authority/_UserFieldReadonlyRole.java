 ...
 *
 */
public class _UserFieldReadonlyRole implements Serializable {
	...
	public _UserFieldReadonlyRole() {

	}

	public _UserFieldReadonlyRole(String tf_fieldRoleId, Integer userid) {
