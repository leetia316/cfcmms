...
@TableDefine(group = "系统设置", id = 9041, title = "只读字段角色")
public class _FieldReadonlyRole implements Serializable {
	...
	@FieldDefine(title = "只读字段角色名称", nameField = true, number = 20)
