...
Ext
		.define(
				'app.module.Grid',
				{
					...
					requires : [ 'app.module.factory.ColumnsFactory',// 'Ext.ux.PreviewPlugin',
					'app.module.widget.PageSizeCombo', 'app.lib.GridPrinter',
							'app.module.widget.column.AuditingActionColumn',
							'app.module.widget.column.PayoutActionColumn',
							'app.module.widget.column.ApproveActionColumn',
							'app.module.widget.column.AttachmentNumberColumn',
							'app.module.widget.OwnPaging',
