...
Ext.define('app.module.ModulePanel', {
	extend : 'Ext.panel.Panel',
	alias : 'widget.modulepanel',
	frame : false,
	border : false,
	layout : 'border',
	requires : [ 'app.module.ToolBar', 'app.module.ChildToolBar',
			'app.module.Grid', 'app.module.Detail', 'app.module.navigate.Navigate',
			'app.module.GridStore', 'Ext.data.Store' ],
	module : null,
	// 是否显示导航栏
