		...
		.define(
				'app.module.factory.ColumnsFactory',
				{
					...
					requires : [ 'Ext.grid.column.Check',
							'app.module.widget.column.RecordIconColumn',
							'app.module.widget.column.ImageColumn',
							'app.module.widget.column.ChildCountColumn',
							'app.module.widget.column.ManyToOneFieldColumn',
							'app.module.widget.column.ChildAggregateColumn',
