...
Ext.define('app.module.factory.FormFieldFactory', {
	requires : [ 'app.lib.ToggleSlide', 'app.lib.MoneyField',
			'app.lib.datetime.DateTimeField', 'app.ux.OwnTreePicker',
			'app.module.widget.field.ImageField',
			'app.module.widget.field.ImageFieldContainer', 'app.ux.TriggerClear',
			'app.ux.iconcls.Field' ],
