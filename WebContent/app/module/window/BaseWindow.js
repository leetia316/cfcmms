 ...
 * merge level=50
 */
Ext.define('app.module.window.BaseWindow', {
	extend : 'Ext.window.Window',
	alias : 'widget.basewindow',

	requires : [ 'app.module.form.DisplayForm', 'app.module.form.NewForm',
			'app.module.form.EditForm', 'app.module.form.AuditingForm',
			'app.module.form.ApproveForm', 'app.module.form.PaymentForm' ],
